...
type (
	...
	AccountBalanceQueryInterface interface {
		GetAccountBalanceByAccountAddress(accountAddress string) string
...
func (q *AccountBalanceQuery) GetAccountBalanceByAccountAddress(accountAddress string) string {
