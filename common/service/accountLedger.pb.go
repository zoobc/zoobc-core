...
func init() { proto.RegisterFile("service/accountLedger.proto", fileDescriptor_3348bbcb1f9dd137) }
...
func NewAccountLedgerServiceClient(cc *grpc.ClientConn) AccountLedgerServiceClient {
