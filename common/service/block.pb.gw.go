...
func local_request_BlockService_GetBlocks_0(ctx context.Context, marshaler runtime.Marshaler, server BlockServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq model.GetBlocksRequest
	var metadata runtime.ServerMetadata
...
var (
	filter_BlockService_GetBlock_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func RegisterBlockServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server BlockServiceServer) error {
	...
	mux.Handle("GET", pattern_BlockService_GetBlocks_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_BlockService_GetBlocks_0(rctx, inboundMarshaler, server, req, pathParams)
	...
	mux.Handle("GET", pattern_BlockService_GetBlock_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_BlockService_GetBlock_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
