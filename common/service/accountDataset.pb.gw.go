...
func local_request_AccountDatasetService_GetAccountDatasets_0(ctx context.Context, marshaler runtime.Marshaler, server AccountDatasetServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq model.GetAccountDatasetsRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetAccountDatasets(ctx, &protoReq)
	return msg, metadata, err
...
func local_request_AccountDatasetService_GetAccountDataset_0(ctx context.Context, marshaler runtime.Marshaler, server AccountDatasetServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq model.GetAccountDatasetRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetAccountDataset(ctx, &protoReq)
	return msg, metadata, err

}

// RegisterAccountDatasetServiceHandlerServer registers the http handlers for service AccountDatasetService to "mux".
// UnaryRPC     :call AccountDatasetServiceServer directly.
// StreamingRPC :currently unsupported pending https://github.com/grpc/grpc-go/issues/906.
func RegisterAccountDatasetServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AccountDatasetServiceServer) error {
	...
	mux.Handle("GET", pattern_AccountDatasetService_GetAccountDatasets_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_AccountDatasetService_GetAccountDatasets_0(rctx, inboundMarshaler, server, req, pathParams)
	...
	mux.Handle("GET", pattern_AccountDatasetService_GetAccountDataset_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_AccountDatasetService_GetAccountDataset_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
