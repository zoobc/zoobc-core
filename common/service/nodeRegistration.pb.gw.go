...
var (
	filter_NodeRegistrationService_UpdateNodeRegistration_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)

func request_NodeRegistrationService_UpdateNodeRegistration_0(ctx context.Context, marshaler runtime.Marshaler, client NodeRegistrationServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq model.UpdateNodeRegistrationRequest
	var metadata runtime.ServerMetadata

	if err := runtime.PopulateQueryParameters(&protoReq, req.URL.Query(), filter_NodeRegistrationService_UpdateNodeRegistration_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := client.UpdateNodeRegistration(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err
...
func RegisterNodeRegistrationServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client NodeRegistrationServiceClient) error {
	...
	mux.Handle("GET", pattern_NodeRegistrationService_UpdateNodeRegistration_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req)
		...
		resp, md, err := request_NodeRegistrationService_UpdateNodeRegistration_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_NodeRegistrationService_UpdateNodeRegistration_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	...
	pattern_NodeRegistrationService_UpdateNodeRegistration_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "nodeRegistration", "UpdateNodeRegistration"}, ""))
)
...
var (
	...
	forward_NodeRegistrationService_UpdateNodeRegistration_0 = runtime.ForwardResponseMessage
)
