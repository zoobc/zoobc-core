...
func local_request_AccountBalanceService_GetAccountBalances_0(ctx context.Context, marshaler runtime.Marshaler, server AccountBalanceServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq model.GetAccountBalancesRequest
	var metadata runtime.ServerMetadata
...
func local_request_AccountBalanceService_GetAccountBalance_0(ctx context.Context, marshaler runtime.Marshaler, server AccountBalanceServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq model.GetAccountBalanceRequest
	var metadata runtime.ServerMetadata
...
// RegisterAccountBalanceServiceHandlerServer registers the http handlers for service AccountBalanceService to "mux".
// UnaryRPC     :call AccountBalanceServiceServer directly.
// StreamingRPC :currently unsupported pending https://github.com/grpc/grpc-go/issues/906.
func RegisterAccountBalanceServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AccountBalanceServiceServer) error {
	...
	mux.Handle("GET", pattern_AccountBalanceService_GetAccountBalances_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_AccountBalanceService_GetAccountBalances_0(rctx, inboundMarshaler, server, req, pathParams)
	...
	mux.Handle("GET", pattern_AccountBalanceService_GetAccountBalance_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_AccountBalanceService_GetAccountBalance_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
