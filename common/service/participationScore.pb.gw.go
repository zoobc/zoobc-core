...
var (
	filter_ParticipationScoreService_GetParticipationScores_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)

func request_ParticipationScoreService_GetParticipationScores_0(ctx context.Context, marshaler runtime.Marshaler, client ParticipationScoreServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	msg, err := client.GetParticipationScores(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ParticipationScoreService_GetParticipationScores_0(ctx context.Context, marshaler runtime.Marshaler, server ParticipationScoreServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq model.GetParticipationScoresRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetParticipationScores(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterParticipationScoreServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ParticipationScoreServiceServer) error {
	...
	mux.Handle("GET", pattern_ParticipationScoreService_GetParticipationScores_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ParticipationScoreService_GetParticipationScores_0(rctx, inboundMarshaler, server, req, pathParams)
...
// RegisterParticipationScoreServiceHandlerFromEndpoint is same as RegisterParticipationScoreServiceHandler but
...
func RegisterParticipationScoreServiceHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterParticipationScoreServiceHandler(ctx, mux, conn)
}

// RegisterParticipationScoreServiceHandler registers the http handlers for service ParticipationScoreService to "mux".
...
func RegisterParticipationScoreServiceHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterParticipationScoreServiceHandlerClient(ctx, mux, NewParticipationScoreServiceClient(conn))
}

// RegisterParticipationScoreServiceHandlerClient registers the http handlers for service ParticipationScoreService
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "ParticipationScoreServiceClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "ParticipationScoreServiceClient"
// doesn't go through the normal gRPC flow (creating a gRPC client etc.) then it will be up to the passed in
// "ParticipationScoreServiceClient" to call the correct interceptors.
func RegisterParticipationScoreServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ParticipationScoreServiceClient) error {
	...
	mux.Handle("GET", pattern_ParticipationScoreService_GetParticipationScores_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ParticipationScoreService_GetParticipationScores_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
