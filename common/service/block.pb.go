...
var fileDescriptor_9727476210275ad5 = []byte{
	...
	0x64, 0xe6, 0xe7, 0x15, 0x43, 0x64, 0x8d, 0x8e, 0x32, 0x72, 0xf1, 0x38, 0x81, 0x54, 0x07, 0x43,
	...
	0xcc, 0x10, 0xe2, 0x0e, 0x7d, 0x84, 0x79, 0x11, 0x5c, 0x1c, 0x30, 0x8e, 0x90, 0x18, 0x9a, 0x11,
	0xe8, 0x46, 0x83, 0x05, 0x5d, 0x2b, 0x4a, 0x52, 0xf3, 0x52, 0x52, 0x53, 0x3c, 0xf3, 0xd2, 0xf2,
	0x95, 0xa4, 0xc0, 0x46, 0x8b, 0x08, 0x09, 0x61, 0x1a, 0xed, 0xa4, 0x13, 0xa5, 0x95, 0x9e, 0x59,
	0x92, 0x51, 0x9a, 0xa4, 0x97, 0x9c, 0x9f, 0xab, 0x5f, 0x95, 0x9f, 0x9f, 0x94, 0x0c, 0x21, 0x75,
	0x93, 0xf3, 0x8b, 0x52, 0xf5, 0x93, 0xf3, 0x73, 0x73, 0xf3, 0xf3, 0xf4, 0xa1, 0xc1, 0x94, 0xc4,
	0x06, 0xf6, 0xbc, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0xdd, 0xb8, 0x85, 0x40, 0x4d, 0x01, 0x00,
	0x00,
}
...
type BlockServiceClient interface {
	...
	GetBlock(ctx context.Context, in *model.GetBlockRequest, opts ...grpc.CallOption) (*model.BlockExtendedInfo, error)
}
...
func (c *blockServiceClient) GetBlock(ctx context.Context, in *model.GetBlockRequest, opts ...grpc.CallOption) (*model.BlockExtendedInfo, error) {
	out := new(model.BlockExtendedInfo)
...
type BlockServiceServer interface {
	...
	GetBlock(context.Context, *model.GetBlockRequest) (*model.BlockExtendedInfo, error)
}
...
func (*UnimplementedBlockServiceServer) GetBlock(ctx context.Context, req *model.GetBlockRequest) (*model.BlockExtendedInfo, error) {
