...
func (*UnimplementedNodeRegistrationServiceServer) GetNodeRegistration(ctx context.Context, req *model.GetNodeRegistrationRequest) (*model.NodeRegistration, error) {
