...
func TestEstoniaEidAccountType_VerifySignature(t *testing.T) {
	...
	mockPublicKeyBytes, _ := hex.DecodeString(
		"04acf16bf960e6797993a7fd08ad4464fde0b7eefe543d119552c4d1e786dd851903afe925ac1414cefaac741c5200fa92c5f37a30a87430fc59bb543ff768a3cbc934548774b5645b2c3209b2a928c1cb7b52c2bb973690dddf7c348585907b27",
	)
	mockSignature, _ := hex.DecodeString(
		"00B87DCEC8616E0BC01D84A903B77E4BD70F7812378DDD90EF2F7253B011E49E49E8F4544E5F470227FE406E26B4A104BEDE622BC94689381C07E651CA53C1EB55160B6DB55B4E075C1289BE791CB485751E135B010DC52FE146CAB4ED31FF3F",
	)
	type fields struct {
		publicKey   []byte
		fullAddress []byte
