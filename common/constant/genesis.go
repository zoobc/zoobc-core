...
const (
	MainchainGenesisBlockID int64 = -6838653589934812782
)
...
var (
	...
	GenesisConfig = []GenesisConfigEntry{
		// TODO: after dynamic ip system is merged in develop,
		//  uncomment below (commented code) for alpha branch and remove from develop/experimental
		// {
