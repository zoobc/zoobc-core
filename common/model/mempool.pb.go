...
func (*MempoolTransaction) Descriptor() ([]byte, []int) {
	return fileDescriptor_mempool_33d261dd8c5a5eb0, []int{0}
}
...
func (*GetMempoolTransactionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_mempool_33d261dd8c5a5eb0, []int{1}
}
...
func (*GetMempoolTransactionsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_mempool_33d261dd8c5a5eb0, []int{2}
}
...
func (*GetMempoolTransactionsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_mempool_33d261dd8c5a5eb0, []int{3}
}
...
func init() { proto.RegisterFile("model/mempool.proto", fileDescriptor_mempool_33d261dd8c5a5eb0) }

var fileDescriptor_mempool_33d261dd8c5a5eb0 = []byte{
