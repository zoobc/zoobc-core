...
type Transaction_LiquidPaymentTransactionBody struct {
	LiquidPaymentTransactionBody *LiquidPaymentTransactionBody `protobuf:"bytes,25,opt,name=liquidPaymentTransactionBody,proto3,oneof"`
}

type Transaction_LiquidPaymentStopTransactionBody struct {
	LiquidPaymentStopTransactionBody *LiquidPaymentStopTransactionBody `protobuf:"bytes,26,opt,name=liquidPaymentStopTransactionBody,proto3,oneof"`
}
...
var fileDescriptor_8333001f09b34082 = []byte{
	...
	,
}
