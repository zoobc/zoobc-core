...
func TestGetUnsignedReceiptBytes(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: []byte{
				1, 2, 3, 3, 2, 1, 0, 0, 0, 0, 166, 159, 115, 204, 162, 58, 154, 197, 200, 181, 103, 220, 24, 90, 117,
				110, 151, 201, 130, 22, 79, 226, 88, 89, 224, 209, 220, 193, 71, 92, 128, 166, 21, 178, 18, 58, 241,
				245, 249, 76, 17, 227, 233, 64, 44, 58, 197, 88, 245, 0, 25, 157, 149, 182, 211, 227, 1, 117, 133, 134,
				40, 29, 205, 38, 1, 0, 0, 0, 1, 2, 3,
			},
		},
	}
	for _, tt := range tests {
