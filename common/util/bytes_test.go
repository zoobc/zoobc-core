...
func TestSplitByteSliceByChunkSize(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantSplitSlice: [][]byte{
				[]byte{153, 58, 50, 200, 7, 61, 108, 229, 204, 48},
				[]byte{199, 145, 21, 99, 125, 75, 49, 45, 118, 97},
				[]byte{219, 80, 242, 244, 100, 134, 144, 246, 37, 144},
				[]byte{213, 135},
			},
		},
		{
			...
			wantSplitSlice: [][]byte{
				[]byte{153, 58, 50, 200, 7, 61, 108, 229, 204, 48, 199, 145, 21, 99, 125, 75, 49,
					45, 118, 97, 219, 80, 242, 244, 100, 134, 144, 246, 37, 144, 213, 135},
			},
		},
		{
