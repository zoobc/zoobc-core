...
func TestGenerateProofOfOwnership(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: &wantStruct{
				proofOfOwnershipSign: []byte{115, 74, 30, 212, 221, 118, 106, 246, 87, 93, 149, 146, 141, 111, 100, 45, 29, 48, 16,
					212, 236, 60, 30, 50, 73, 134, 217, 91, 220, 41, 69, 7, 44, 181, 253, 159, 156, 174, 68, 206, 19, 51, 47, 211,
