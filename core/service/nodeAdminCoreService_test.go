...
func TestNodeAdminService_GenerateProofOfOwnership(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: &model.ProofOfOwnership{
				MessageBytes: []byte{18, 44, 66, 67, 90, 69, 71, 79, 98, 51, 87, 78, 120, 51, 102, 68, 79, 86, 102,
					57, 90, 83, 52, 69, 106, 118, 79, 73, 118, 95, 85, 101, 87, 52, 84, 86, 66, 81, 74, 95, 54, 116,
					72, 75, 108, 69, 26, 64, 166, 159, 115, 204, 162, 58, 154, 197, 200, 181, 103, 220, 24, 90, 117,
					110, 151, 201, 130, 22, 79, 226, 88, 89, 224, 209, 220, 193, 71, 92, 128, 166, 21, 178, 18, 58,
					241, 245, 249, 76, 17, 227, 233, 64, 44, 58, 197, 88, 245, 0, 25, 157, 149, 182, 211, 227, 1, 117,
					133, 134, 40, 29, 205, 38},
				Signature: []byte{80, 11, 56, 125, 196, 83, 221, 38, 32, 222, 237, 91, 83, 128, 50, 41, 69, 112, 152, 61,
					130, 58, 21, 104, 63, 147, 188, 248, 112, 3, 110, 43, 31, 74, 46, 181, 22, 27, 159, 137, 248, 185, 64,
					89, 88, 154, 177, 172, 7, 33, 85, 217, 67, 233, 125, 150, 140, 194, 0, 150, 201, 22, 13, 11},
			},
			wantErr: false,
		},
	}
