...
func GetNumberOfMaxReceipts(numberOfSortedBlocksmiths int) int {
	if numberOfSortedBlocksmiths < constant.PriorityStrategyMaxPriorityPeers {
		return numberOfSortedBlocksmiths - 1
	}
