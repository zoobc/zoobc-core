...
func init() {
	/*
		TXCommandRoot
	*/
	txCmd.PersistentFlags().StringVar(&message, "message", "", "--message \"test message\". Include an arbitrary message in the transaction (max 256 bytes)")
	...
	txCmd.PersistentFlags().StringVar(&recipientAccountAddressHex, "recipient", "", "--recipient 000000006f5461d22d8b6ce3c9b76e2c1078bb1b475a9f5280d30b77353ff53514e5c073. Provide recipient transaction hex format")
	...
	txCmd.PersistentFlags().StringVar(&senderAddressHex, "sender-address", "", "--sender-address 000000006f5461d22d8b6ce3c9b76e2c1078bb1b475a9f5280d30b77353ff53514e5c073. Transaction's sender address, [no necessary if contain --sender-seed]")
