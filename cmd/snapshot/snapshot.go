...
func storingPayloadProcess() func(ccmd *cobra.Command, args []string) {
	return func(ccmd *cobra.Command, args []string) {
		...
		mainBlockService := service.NewBlockMainService(mainChain, nil, executor, query.NewBlockQuery(mainChain), nil, nil, nil, nil, nil, nil, nil, typeSwitcher, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, storage.NewBlockStateStorage(), nil, nil)
