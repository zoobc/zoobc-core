...
func getGenesisBlockID(genesisEntries []genesisEntry) (mainBlockID, spineBlockID int64) {
	...
	bs := service.NewBlockMainService(&chaintype.MainChain{}, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, &transaction.TypeSwitcher{
		MempoolCacheStorage: mempoolStorage,
		NodeAuthValidation:  nodeAuthValidationService,
	}, nil, nil, nil, nil, nil, nil, nil, nil, nil, &transaction.Util{}, &coreUtil.ReceiptUtil{}, nil, nil, nil, nil, nil, nil, nil, nil, query.GetPruneQuery(&chaintype.MainChain{}), nil, nil, nil)
