	...
	mockMultisigInfo = &model.MultiSignatureInfo{
		...
		Addresses: [][]byte{
			[]byte{0, 0, 0, 0, 185, 226, 12, 96, 140, 157, 68, 172, 119, 193, 144, 246, 76, 118, 0, 112, 113, 140, 183, 229,
				116, 202, 211, 235, 190, 224, 217, 238, 63, 223, 225, 162},
			[]byte{0, 0, 0, 0, 8, 32, 68, 38, 181, 138, 127, 184, 190, 125, 84, 174, 13, 162, 122, 62, 183, 130, 70, 18, 103, 47, 177, 161,
				153, 143, 61, 130, 145, 81, 222, 70},
			[]byte{0, 0, 0, 0, 160, 121, 129, 83, 225, 164, 195, 123, 8, 181, 41, 251, 17, 3, 93, 37, 182, 109, 32, 174, 168, 68, 193, 212,
