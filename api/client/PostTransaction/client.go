...
func main() {
	...
	response, err := c.PostTransaction(context.Background(), &rpc_model.PostTransactionRequest{
		...
		// add node
		TransactionBytes: []byte{
			2, 0, 1, 241, 91, 65, 93, 0, 0, 0, 0, 0, 0, 66, 67, 90, 110, 83, 102, 113, 112, 80, 53, 116, 113, 70, 81, 108, 77, 84, 89, 107, 68,
			101, 66, 86, 70, 87, 110, 98, 121, 86, 75, 55, 118, 76, 114, 53, 79, 82, 70, 112, 84, 106, 103, 116, 78, 0, 0, 66, 67, 90, 75, 76,
			118, 103, 85, 89, 90, 49, 75, 75, 120, 45, 106, 116, 70, 57, 75, 111, 74, 115, 107, 106, 86, 80, 118, 66, 57, 106, 112, 73, 106, 102,
			122, 122, 73, 54, 122, 68, 87, 48, 74, 1, 0, 0, 0, 0, 0, 0, 0, 99, 0, 0, 0, 0, 14, 6, 218, 170, 54, 60, 50, 2, 66, 130, 119, 226, 235,
			126, 203, 5, 12, 152, 194, 170, 146, 43, 63, 224, 101, 127, 241, 62, 152, 187, 255, 0, 0, 66, 67, 90, 110, 83, 102, 113, 112, 80, 53,
			116, 113, 70, 81, 108, 77, 84, 89, 107, 68, 101, 66, 86, 70, 87, 110, 98, 121, 86, 75, 55, 118, 76, 114, 53, 79, 82, 70, 112, 84, 106,
			103, 116, 78, 9, 0, 0, 0, 49, 50, 55, 46, 48, 46, 48, 46, 49, 160, 134, 1, 0, 0, 0, 0, 0, 176, 16, 26, 171, 255, 156, 254, 9, 24, 172,
			59, 41, 23, 71, 148, 118, 76, 235, 91, 70, 52, 231, 80, 83, 56, 183, 83, 211, 227, 27, 141, 194, 182, 191, 228, 180, 181, 191, 26, 0,
			244, 155, 183, 20, 173, 240, 223, 244, 169, 47, 97, 238, 216, 48, 189, 244, 147, 66, 165, 114, 206, 28, 151, 14,
		},
	})
