...
func main() {
	...
	response, err := c.PostTransaction(context.Background(), &rpc_model.PostTransactionRequest{
		...
		TransactionBytes: []byte{
			1, 0, 0, 0, 1, 12, 169, 120, 93, 0, 0, 0, 0, 44, 0, 0, 0, 66, 67, 90, 110, 83, 102, 113, 112, 80, 53, 116, 113, 70, 81, 108, 77,
			84, 89, 107, 68, 101, 66, 86, 70, 87, 110, 98, 121, 86, 75, 55, 118, 76, 114, 53, 79, 82, 70, 112, 84, 106, 103, 116, 78, 44, 0,
			0, 0, 66, 67, 90, 75, 76, 118, 103, 85, 89, 90, 49, 75, 75, 120, 45, 106, 116, 70, 57, 75, 111, 74, 115, 107, 106, 86, 80, 118, 66,
			57, 106, 112, 73, 106, 102, 122, 122, 73, 54, 122, 68, 87, 48, 74, 1, 0, 0, 0, 0, 0, 0, 0, 8, 0, 0, 0, 0, 135, 147, 3, 0, 0, 0, 0, 0,
			0, 0, 0, 74, 225, 160, 175, 200, 159, 99, 92, 139, 15, 249, 157, 186, 69, 249, 83, 255, 136, 242, 8, 220, 205, 75, 213, 167, 80, 62,
			125, 65, 188, 189, 132, 42, 110, 127, 36, 195, 14, 37, 2, 130, 233, 202, 178, 16, 95, 90, 142, 232, 211, 248, 130, 105, 16, 47, 202,
			173, 23, 49, 178, 44, 82, 103, 3,
		},
		// add node
		// TransactionBytes: []byte{
