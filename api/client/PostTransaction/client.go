...
func main() {
	...
	response, err := c.PostTransaction(context.Background(), &rpc_model.PostTransactionRequest{
		...
		TransactionBytes: []byte{
			...
			125, 220, 90, 238, 46, 99, 182, 57, 73, 252, 197, 246, 137, 34, 98, 100, 37, 159, 196, 149, 89, 11, 110, 219, 204, 38, 120, 172, 186,
			147, 139, 94, 66, 224, 221, 242, 39, 205, 3, 131, 119, 183, 198, 255, 98, 10, 42, 76, 160, 213, 11, 134, 129, 128, 208, 20, 215, 77,
			192, 53, 123, 11,
		},
		// add node
		// TransactionBytes: []byte{
