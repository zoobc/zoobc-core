...
func main() {
	...
	response, err := c.PostTransaction(context.Background(), &rpc_model.PostTransactionRequest{
		...
		TransactionBytes: []byte{2, 2, 0, 0, 1, 234, 112, 141, 93, 0, 0, 0, 0, 44, 0, 0, 0, 66, 67, 90, 69, 71, 79, 98, 51, 87, 78, 120, 51, 102, 68, 79, 86, 102, 57, 90, 83, 52, 69, 106, 118, 79, 73, 118, 95, 85, 101, 87, 52, 84, 86, 66, 81, 74, 95, 54, 116, 72, 75, 108, 69, 44, 0, 0, 0, 66, 67, 90, 69, 71, 79, 98, 51, 87, 78, 120, 51, 102, 68, 79, 86, 102, 57, 90, 83, 52, 69, 106, 118, 79, 73, 118, 95, 85, 101, 87, 52, 84, 86, 66, 81, 74, 95, 54, 116, 72, 75, 108, 69, 1, 0, 0, 0, 0, 0, 0, 0, 32, 0, 0, 0, 153, 58, 50, 200, 7, 61, 108, 229, 204, 48, 199, 145, 21, 99, 125, 75, 49, 45, 118, 97, 219, 80, 242, 244, 100, 134, 144, 246, 37, 144, 213, 135, 0, 0, 0, 0, 198, 233, 202, 223, 179, 244, 150, 151, 79, 110, 147, 215, 52, 110, 180, 63, 52, 9, 206, 82, 172, 121, 167, 64, 9, 209, 95, 23, 68, 5, 94, 110, 64, 188, 165, 254, 244, 196, 203, 245, 29, 248, 12, 97, 225, 180, 66, 130, 187, 42, 93, 161, 96, 224, 21, 157, 27, 131, 44, 248, 142, 131, 24, 13},
		// TransactionBytes: []byte{
